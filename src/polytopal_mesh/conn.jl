...
facets(::Type{Polytope"3-node triangle"}) = (
  (Polytope"2-node line", (1, 2)),
  (Polytope"2-node line", (2, 3)),
...
canonicalize_connectivity(e::Connectivity{Edge, Vertex}) = is_cannonical(e) ? e : flip_orientation(e)

is_cannonical(e::Connectivity{Edge, Vertex}) = e[1]<e[2]
